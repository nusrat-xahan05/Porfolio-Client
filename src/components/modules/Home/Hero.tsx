...
const Hero = () => {
    ...
    return (
        <section className="pt-32 lg:pt-20 xl:pt-[70px] relative">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-x-8">
                    {/* Banner Content */}
                    <div className="2xl:pl-14 flex flex-col justify-center text-center lg:text-left mx-auto lg:mx-0 py-3.5">
