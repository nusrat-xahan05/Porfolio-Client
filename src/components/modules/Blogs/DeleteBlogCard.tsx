...
// import { deleteBlogBySlug } from "@/actions/blog/deleteBlogBySlug";
// import { toast } from "sonner";

// interface DeleteBlogCardProps {
//     slug: string;
// }

// export default function DeleteBlogCard({ slug }: DeleteBlogCardProps) {
//     const router = useRouter();

//     const handleDelete = async (slug: string) => {
//         const toastId = toast.loading("Processing....");
//         try {
//             const res = await deleteBlogBySlug(slug)
